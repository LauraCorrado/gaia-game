  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      <section aria-labelledby="team-title" className="mb-12">
        <h1 id="team-title" className="text-lm-text-primary dark:text-dm-text-primary mb-4">
          Il Team
        </h1>
        <p className="text-lm-text-secondary dark:text-dm-text-secondary text-lg max-w-2xl">
          Il progetto GAIA coinvolge un partenariato interdisciplinare composto da
          aziende e istituzioni accademiche calabresi.
        </p>
      </section>
