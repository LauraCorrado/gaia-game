    ...
    >
      ...
      <div className="flex flex-col gap-8">
        ...
        <section>
          ...
          <h3 className="text-lm-text-primary dark:text-dm-text-primary mb-2">
            2.1 Dati forniti volontariamente dall’utente
          </h3>
          <p className="text-lm-text-secondary dark:text-dm-text-secondary">
            Tramite il modulo di contatto l’utente può fornire:
          </p>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-2 text-lm-text-secondary dark:text-dm-text-secondary">
            <li>trasmissione dell’indirizzo IP</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-2 text-lm-text-secondary dark:text-dm-text-secondary">
            ...
            <li>misure di sicurezza adeguate</li>
          </ul>
        </section>
