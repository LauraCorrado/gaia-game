  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      <section aria-labelledby="news-title" className="mb-12">
        <h1 id="news-title" className="text-lm-text-primary dark:text-dm-text-primary mb-4">
          Eventi e News
        </h1>
        <p className="text-lm-text-secondary dark:text-dm-text-secondary text-lg max-w-2xl">
          Aggiornamenti sulle attività del progetto, eventi seminariali e newsletter
          periodiche (prodotte da Studio Rubino).
        </p>
      </section>
